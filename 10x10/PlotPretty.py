...
def pp(colormode):
	...
	mpl.rcParams['lines.linewidth']= 1.2     # line width in points


	#lines.linestyle   : -       # solid line
	#lines.color       : white    # has no affect on plot(); see axes.color_cycle
	mpl.rcParams['lines.color']=topcolor
	...
	#text.color          : white
	mpl.rcParams['text.color']=topcolor
	...
	mpl.rcParams['axes.facecolor']=botcolor
	#axes.edgecolor      : white   # axes edge color
	mpl.rcParams['axes.edgecolor']=topcolor
	...
	mpl.rcParams['axes.labelcolor']=topcolor
	...
	#xtick.color          : w      # color of the tick labels
	mpl.rcParams['xtick.color']=tc
	...
	mpl.rcParams['ytick.color']=tc      # color of the tick labels
	...
	### GRIDS
	mpl.rcParams['grid.color']=tc      # grid color
	...
	#figure.facecolor : 1    # figure facecolor; 1 is scalar white
	mpl.rcParams['figure.facecolor'] =bcN    # figure facecolor; 0 is scalar black



	mpl.rcParams['figure.edgecolor'] = botcolor   # figure edgecolor
