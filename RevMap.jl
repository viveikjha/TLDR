...
chi2_act = Chi2(Mod,DATA.L,DATA.EL)
println("#####################################")
println("Chi2 on actual vdm: ", chi2_act)
println("#####################################")
#writecsv("H.csv",Mats.H)
#println(Mats.H[1:20])
#println(vdm_act[1:20])
#println(DATA.L[1:20])
#println(DATA.EL[1:20])

#figure(1)
#imshow(Mats.H,aspect="auto")
#title("H Matrix")

#figure(2)
#imshow(vdm_act,aspect="auto")
#title("vdm")

#figure(3)
#imshow(Mod,aspect="auto")
#title("Model")
#show()

#figure(4)
#imshow(DATA.L,aspect="auto")
#title("L")
#show()
